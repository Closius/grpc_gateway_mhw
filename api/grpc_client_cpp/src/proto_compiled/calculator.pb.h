...
class StartLongProcessStreaming_request;
struct StartLongProcessStreaming_requestDefaultTypeInternal;
extern StartLongProcessStreaming_requestDefaultTypeInternal _StartLongProcessStreaming_request_default_instance_;
class StartLongProcessStreaming_response;
struct StartLongProcessStreaming_responseDefaultTypeInternal;
extern StartLongProcessStreaming_responseDefaultTypeInternal _StartLongProcessStreaming_response_default_instance_;
class StopLongProcessStreaming_request;
struct StopLongProcessStreaming_requestDefaultTypeInternal;
extern StopLongProcessStreaming_requestDefaultTypeInternal _StopLongProcessStreaming_request_default_instance_;
}  // namespace calculator
PROTOBUF_NAMESPACE_OPEN
...
template<> ::calculator::StartLongProcessStreaming_request* Arena::CreateMaybeMessage<::calculator::StartLongProcessStreaming_request>(Arena*);
template<> ::calculator::StartLongProcessStreaming_response* Arena::CreateMaybeMessage<::calculator::StartLongProcessStreaming_response>(Arena*);
template<> ::calculator::StopLongProcessStreaming_request* Arena::CreateMaybeMessage<::calculator::StopLongProcessStreaming_request>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace calculator {
...
class StartLongProcessStreaming_request final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:calculator.StartLongProcessStreaming_request) */ {
 public:
  inline StartLongProcessStreaming_request() : StartLongProcessStreaming_request(nullptr) {}
  ~StartLongProcessStreaming_request() override;
  explicit constexpr StartLongProcessStreaming_request(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  StartLongProcessStreaming_request(const StartLongProcessStreaming_request& from);
  StartLongProcessStreaming_request(StartLongProcessStreaming_request&& from) noexcept
    : StartLongProcessStreaming_request() {
    *this = ::std::move(from);
  }

  inline StartLongProcessStreaming_request& operator=(const StartLongProcessStreaming_request& from) {
    CopyFrom(from);
    return *this;
  }
  inline StartLongProcessStreaming_request& operator=(StartLongProcessStreaming_request&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const StartLongProcessStreaming_request& default_instance() {
    return *internal_default_instance();
  }
  static inline const StartLongProcessStreaming_request* internal_default_instance() {
    return reinterpret_cast<const StartLongProcessStreaming_request*>(
               &_StartLongProcessStreaming_request_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    12;

  friend void swap(StartLongProcessStreaming_request& a, StartLongProcessStreaming_request& b) {
    a.Swap(&b);
  }
  inline void Swap(StartLongProcessStreaming_request* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(StartLongProcessStreaming_request* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  StartLongProcessStreaming_request* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<StartLongProcessStreaming_request>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const StartLongProcessStreaming_request& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom(const StartLongProcessStreaming_request& from);
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to, const ::PROTOBUF_NAMESPACE_ID::Message& from);
  public:
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(StartLongProcessStreaming_request* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "calculator.StartLongProcessStreaming_request";
  }
  protected:
  explicit StartLongProcessStreaming_request(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
...
class StartLongProcessStreaming_response final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:calculator.StartLongProcessStreaming_response) */ {
 public:
  inline StartLongProcessStreaming_response() : StartLongProcessStreaming_response(nullptr) {}
  ~StartLongProcessStreaming_response() override;
  explicit constexpr StartLongProcessStreaming_response(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  StartLongProcessStreaming_response(const StartLongProcessStreaming_response& from);
  StartLongProcessStreaming_response(StartLongProcessStreaming_response&& from) noexcept
    : StartLongProcessStreaming_response() {
    *this = ::std::move(from);
  }

  inline StartLongProcessStreaming_response& operator=(const StartLongProcessStreaming_response& from) {
    CopyFrom(from);
    return *this;
  }
  inline StartLongProcessStreaming_response& operator=(StartLongProcessStreaming_response&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const StartLongProcessStreaming_response& default_instance() {
    return *internal_default_instance();
  }
  static inline const StartLongProcessStreaming_response* internal_default_instance() {
    return reinterpret_cast<const StartLongProcessStreaming_response*>(
               &_StartLongProcessStreaming_response_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    13;

  friend void swap(StartLongProcessStreaming_response& a, StartLongProcessStreaming_response& b) {
    a.Swap(&b);
  }
  inline void Swap(StartLongProcessStreaming_response* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(StartLongProcessStreaming_response* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  StartLongProcessStreaming_response* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<StartLongProcessStreaming_response>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const StartLongProcessStreaming_response& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom(const StartLongProcessStreaming_response& from);
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to, const ::PROTOBUF_NAMESPACE_ID::Message& from);
  public:
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(StartLongProcessStreaming_response* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "calculator.StartLongProcessStreaming_response";
  }
  protected:
  explicit StartLongProcessStreaming_response(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
...
class StopLongProcessStreaming_request final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:calculator.StopLongProcessStreaming_request) */ {
 public:
  inline StopLongProcessStreaming_request() : StopLongProcessStreaming_request(nullptr) {}
  ~StopLongProcessStreaming_request() override;
  explicit constexpr StopLongProcessStreaming_request(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  StopLongProcessStreaming_request(const StopLongProcessStreaming_request& from);
  StopLongProcessStreaming_request(StopLongProcessStreaming_request&& from) noexcept
    : StopLongProcessStreaming_request() {
    *this = ::std::move(from);
  }

  inline StopLongProcessStreaming_request& operator=(const StopLongProcessStreaming_request& from) {
    CopyFrom(from);
    return *this;
  }
  inline StopLongProcessStreaming_request& operator=(StopLongProcessStreaming_request&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const StopLongProcessStreaming_request& default_instance() {
    return *internal_default_instance();
  }
  static inline const StopLongProcessStreaming_request* internal_default_instance() {
    return reinterpret_cast<const StopLongProcessStreaming_request*>(
               &_StopLongProcessStreaming_request_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    14;

  friend void swap(StopLongProcessStreaming_request& a, StopLongProcessStreaming_request& b) {
    a.Swap(&b);
  }
  inline void Swap(StopLongProcessStreaming_request* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(StopLongProcessStreaming_request* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  StopLongProcessStreaming_request* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<StopLongProcessStreaming_request>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const StopLongProcessStreaming_request& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom(const StopLongProcessStreaming_request& from);
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to, const ::PROTOBUF_NAMESPACE_ID::Message& from);
  public:
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(StopLongProcessStreaming_request* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "calculator.StopLongProcessStreaming_request";
  }
  protected:
  explicit StopLongProcessStreaming_request(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  ...
  PROTOBUF_NODISCARD std::string* release_say();
...
// string sequence = 1 [(.grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = {
inline void StartLongProcessStreaming_request::clear_sequence() {
  sequence_.ClearToEmpty();
}
inline const std::string& StartLongProcessStreaming_request::sequence() const {
  // @@protoc_insertion_point(field_get:calculator.StartLongProcessStreaming_request.sequence)
  return _internal_sequence();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void StartLongProcessStreaming_request::set_sequence(ArgT0&& arg0, ArgT... args) {
 ...
 sequence_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:calculator.StartLongProcessStreaming_request.sequence)
}
inline std::string* StartLongProcessStreaming_request::mutable_sequence() {
  std::string* _s = _internal_mutable_sequence();
  // @@protoc_insertion_point(field_mutable:calculator.StartLongProcessStreaming_request.sequence)
  return _s;
}
inline const std::string& StartLongProcessStreaming_request::_internal_sequence() const {
  return sequence_.Get();
}
inline void StartLongProcessStreaming_request::_internal_set_sequence(const std::string& value) {
  
  sequence_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* StartLongProcessStreaming_request::_internal_mutable_sequence() {
  
  return sequence_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* StartLongProcessStreaming_request::release_sequence() {
  // @@protoc_insertion_point(field_release:calculator.StartLongProcessStreaming_request.sequence)
  return sequence_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void StartLongProcessStreaming_request::set_allocated_sequence(std::string* sequence) {
  if (sequence != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:calculator.StartLongProcessStreaming_request.sequence)
}
...
// string message = 1;
inline void StartLongProcessStreaming_response::clear_message() {
  message_.ClearToEmpty();
}
inline const std::string& StartLongProcessStreaming_response::message() const {
  // @@protoc_insertion_point(field_get:calculator.StartLongProcessStreaming_response.message)
  return _internal_message();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void StartLongProcessStreaming_response::set_message(ArgT0&& arg0, ArgT... args) {
 
 message_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:calculator.StartLongProcessStreaming_response.message)
}
inline std::string* StartLongProcessStreaming_response::mutable_message() {
  std::string* _s = _internal_mutable_message();
  // @@protoc_insertion_point(field_mutable:calculator.StartLongProcessStreaming_response.message)
  return _s;
}
inline const std::string& StartLongProcessStreaming_response::_internal_message() const {
  return message_.Get();
}
inline void StartLongProcessStreaming_response::_internal_set_message(const std::string& value) {
  
  message_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* StartLongProcessStreaming_response::_internal_mutable_message() {
  
  return message_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* StartLongProcessStreaming_response::release_message() {
  // @@protoc_insertion_point(field_release:calculator.StartLongProcessStreaming_response.message)
  return message_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void StartLongProcessStreaming_response::set_allocated_message(std::string* message) {
  if (message != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:calculator.StartLongProcessStreaming_response.message)
}
...
// string say = 1 [(.grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = {
inline void StopLongProcessStreaming_request::clear_say() {
  say_.ClearToEmpty();
}
inline const std::string& StopLongProcessStreaming_request::say() const {
  // @@protoc_insertion_point(field_get:calculator.StopLongProcessStreaming_request.say)
  return _internal_say();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void StopLongProcessStreaming_request::set_say(ArgT0&& arg0, ArgT... args) {
 
 say_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:calculator.StopLongProcessStreaming_request.say)
}
inline std::string* StopLongProcessStreaming_request::mutable_say() {
  std::string* _s = _internal_mutable_say();
  // @@protoc_insertion_point(field_mutable:calculator.StopLongProcessStreaming_request.say)
  return _s;
}
inline const std::string& StopLongProcessStreaming_request::_internal_say() const {
  return say_.Get();
}
inline void StopLongProcessStreaming_request::_internal_set_say(const std::string& value) {
  
  say_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* StopLongProcessStreaming_request::_internal_mutable_say() {
  
  return say_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* StopLongProcessStreaming_request::release_say() {
  // @@protoc_insertion_point(field_release:calculator.StopLongProcessStreaming_request.say)
  return say_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void StopLongProcessStreaming_request::set_allocated_say(std::string* say) {
  if (say != nullptr) {
  ...
  say_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), say,
      GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (say_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
    say_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:calculator.StopLongProcessStreaming_request.say)
}
