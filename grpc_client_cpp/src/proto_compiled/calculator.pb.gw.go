...
func RegisterCalculatorHandlerServer(ctx context.Context, mux *runtime.ServeMux, server CalculatorServer) error {
	...
	mux.Handle("POST", pattern_Calculator_DoMath_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		ctx, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/calculator.Calculator/DoMath", runtime.WithHTTPPathPattern("/domath"))
		if err != nil {
...
func RegisterCalculatorHandlerClient(ctx context.Context, mux *runtime.ServeMux, client CalculatorClient) error {
	...
	mux.Handle("POST", pattern_Calculator_DoMath_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateContext(ctx, mux, req, "/calculator.Calculator/DoMath", runtime.WithHTTPPathPattern("/domath"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_Calculator_DoMath_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"domath"}, ""))
)
